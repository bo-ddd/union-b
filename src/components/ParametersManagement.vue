    ...
    <div class="main">
        ...
        <div class="list">
          ...
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="operate" label="操作" align="center">
              <template slot-scope="scope">
                <el-button size="mini" @click="getCommodityDat(scope)"
                  >编辑</el-button
                >

                <el-dialog title="修改信息" :visible.sync="dialogFormVisibles">
                  <el-form :model="form">
                 <el-form-item label="ID" :label-width="formLabelWidth" class="form-money">
      ...
      <el-input v-model="form.value" autocomplete="off"></el-input>
                  ...
                  <div slot="footer" class="dialog-footer">
                    ...
                    <el-button
                      type="primary"
                      @click="update(scope),(dialogFormVisibles = false)"
                      >确 定</el-button
                    >
                  </div>
                </el-dialog>
...
export default {
  ...
  methods: {
    ...mapActions(["createAttribute","getAttributeList","attributeOrders","deleteAttribute","getProductList","attributeStick","getCategoryList","updateAttribute"]),
    ...
    async update(){
      let res = await this.updateAttribute({
